...
import '../../components/sample_list_item.dart';
import './page_concern.dart';
...
class _PageHome extends State<PageHome> {
  ...
  LinkHeaderNotifier _linkNotifier = LinkHeaderNotifier();
  ValueNotifier<bool> _secondFloorOpen = ValueNotifier<bool>(false);
  ...
  Widget renderConcern() {
    return PageConcern();
  }

  Widget renderRecommend() {
    return SecondFloorPage(pageIndex: _pageIndex, changePage: changePageIndex);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        child: HomeHeader(pageIndex: _pageIndex, changePage: changePageIndex),
...
class SecondFloorPage extends StatefulWidget {
  SecondFloorPage({Key? key,required this.pageIndex, required this.changePage})
      : super(key: key);
  final changePage;
  int pageIndex;
  @override
              ...
              slivers: <Widget>[
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    centerTitle: false,
                    title: Text('以为您精选$_count件商品', style: TextStyle(fontSize: 12, color: Colors.orange),),
                  ),
                ),
                SliverList(
